...
export const commands = {
  ...
  async moveSession(sessionId: string, targetFolderPath: string,): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:fs-sync|move_session", { sessionId, targetFolderPath, },),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any, };
  ...
  async scanAndRead(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:fs-sync|scan_and_read", { scanDir, filePatterns, recursive, pathFilter, },),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any, };
  ...
  async attachmentSave(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:fs-sync|attachment_save", { sessionId, data, filename, },),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any, };
  ...
  async attachmentRemove(sessionId: string, attachmentId: string,): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:fs-sync|attachment_remove", { sessionId, attachmentId, },),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any, };
...
export type CleanupTarget = { type: "files"; subdir: string; extension: string; } | {
  type: "dirs";
  subdir: string;
  marker_file: string;
} | { type: "filesRecursive"; subdir: string; marker_file: string; extension: string; };
